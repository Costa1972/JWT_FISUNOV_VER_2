...
import ru.costa.JWT_FISUNOV_VER_2.dtos.UserDto;
...
public class AuthService {
    ...
    public ResponseEntity<?> createNewUser(@RequestBody RegistrationUserDto registrationUserDto) {
        ...
        if (userService.findUserInDBByName(registrationUserDto.getUsername()).isPresent()) {
            return new ResponseEntity<>(new AppError(HttpStatus.BAD_REQUEST.value(), "Поьзователь уже существует."), HttpStatus.BAD_REQUEST);
        }
